...
std::shared_ptr<pten::DenseTensor> GetInnerDstTensor(VarType* dst) {
  PADDLE_THROW(
      platform::errors::Unavailable("GetInnerDstTensor should return non null "
                                    "std::shared_ptr<pten::DenseTensor>"));
  return nullptr;
}
...
std::shared_ptr<pten::DenseTensor> GetInnerSrcTensor(const VarType& src) {
  PADDLE_THROW(
      platform::errors::Unavailable("GetInnerSrcTensor should return non null "
                                    "std::shared_ptr<pten::DenseTensor>"));
  return nullptr;
}
